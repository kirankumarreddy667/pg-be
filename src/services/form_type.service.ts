...
export class FormTypeService {
  static async createFormType(data: { name: string; description?: string | null }): Promise<FormType> {
  ...
  static async updateFormType(id: number, data: { name?: string; description?: string | null }): Promise<FormType | null> {
