...
export class CouponController {
  static getAllCoupons: RequestHandler = async (req, res, next) => {
    try {
  ...
  static createCoupon: RequestHandler = async (req, res, next) => {
    try {
      if (!req.file) {
  ...
  static checkCoupon: RequestHandler = async (req, res, next) => {
    try {
